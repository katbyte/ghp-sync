...
var prRefreshDefaultFields = []string{"Status", "PR#", "User", "Open Days", "Created At", "Closed At", "Merged At", "Merged By", "Reviewed By", "Approved By", "Changes Requested By", "Reviewed At", "CI", "Mergeable"}
...
var prRefreshOpenFields = map[string]bool{"PR#": true, "User": true, "Created At": true, "Open Days": true, "Reviewed By": true, "Approved By": true, "Changes Requested By": true, "Reviewed At": true, "CI": true, "Mergeable": true}
...
func CmdPRsRefresh(_ *cobra.Command, _ []string) error {
	...
	for _, fieldName := range prFields {
		if fieldName == "Reviewed By" || fieldName == "Approved By" || fieldName == "Changes Requested By" || fieldName == "Reviewed At" {
			needReviews = true
		}
