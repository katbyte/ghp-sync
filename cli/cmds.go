...
to override the default field list, and --dry-run to preview.`,
	...
	refreshCmd.Flags().Bool("include-open", false, "also refresh open prs, limited to fields safe without full pr data (PR#, User, Created At, Open Days, Reviewed By, Approved By, Changes Requested By, Reviewed At, Last Reviewer)")
